...
if (lang == '/id_ID') {
  $('#id_ID').addClass('active')
} else if (lang == '/en_EN') {
  $('#en_EN').addClass('active')
}
...
$(document).ready(function(){
  $('.play').on('click', function(e){
    if (e.target.classList == 'play') {
      e.target.src = "icons/audio/icons8-play-button-circled-64.png";
      e.target.classList.add('playing');
      music.pause();
  
    } else {
      e.target.src = "icons/audio/icons8-pause-button-64.png";
  ...
  $('.unmute').on('click', function(e){
    if (e.target.classList == 'unmute') {
      e.target.src = "icons/audio/icons8-volume-64.png";
      e.target.classList.add('playing');
      music.muted = false;
      
    } else {
      e.target.src = "icons/audio/icons8-no-audio-64.png";
      e.target.classList.remove('playing');
      music.muted = true;
    }
  })
...
// function playVideo () {
//   document.querySelector('video').forEach(function(e) {
//     e.play();
//   });
// }
// function play(){
...
// $.getScript('content.js', function name() {
//   console.log(test);
//   return lorem;
// });
...
// console.log($('<h1> Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae repellat aliquam optio obcaecati hic deserunt beatae voluptatum aut asperiores reprehenderit modi ratione ex molestiae sint saepe consectetur omnis,</h1> <img src="img/1.jpg"> <h1>quas qui voluptatibus nulla, voluptates autem architecto commodi magni. Molestiae, veritatis aliquam.</h1>'));
...
let FlipbookView = SingleView.extend({
  el: '#flipbook',
  events: {
  ...
  render: function() {
    let settings = window.FlipbookSettings;
    let options = $.extend({
      responsive: true,
  ...
  _keydownEvent: function(event) {
    let nextArrow = 39, preletrow = 37;
    if (event.keyCode==preletrow) {
      this.$el.turn('previous');
  ...
  _let: function() {
    let content = $.getScript('content.js', function(){
      return lorem
    })
  },
  // main content
  _getPageElement: function(pageNumber) {
    let $el = $('<div style="position: relative"></img><div class="main-page-number"><span>'+(pageNumber-1)+'</span></div></div>'),
    settings = window.FlipbookSettings
    let imgr
    
    const content = [
      '<img src="img'+lang+'/1.png" style="position:relative; z-index: 999">',
      '<img src="img'+lang+'/2.png"></img>',
      '<img src="img'+lang+'/3.png"></img>',
      '<img src="img'+lang+'/4.png"></img>',
      '<img src="img'+lang+'/5.png"></img>',
      '<div style="background-image: url(img'+lang+'/6.png); background-size: cover; background-repead: no-repead; width: 100%; height: 100%"><video controls src="videos/Ubaya.mp4" style="width: 83%; height: 35%; margin: auto; display: block"></video></div>',
      '<img src="img'+lang+'/7.png"></img>',
      '<img src="img'+lang+'/8.png"></img>',
      '<img src="img'+lang+'/9.png"></img>',
      '<img src="img'+lang+'/10.png"></img>',
      '<img src="img'+lang+'/11.png"></img>',
      '<img src="img'+lang+'/12.png"></img>',
      '<img src="img'+lang+'/13.png"></img>',
      '<img src="img'+lang+'/14.png"></img>',
      '<img src="img'+lang+'/15.png"></img>',
      '<img src="img'+lang+'/16.png"></img>',
      '<img src="img'+lang+'/17.png"></img>',
      '<div style="height: 100%; display:flex; background-image: url(img/background/background.jpg); background-size:650px 100%; background-repeat: no-repeat; background-position: -50px; flex-direction: column;"><h1 style="margin: 0; text-align: center; margin-top: 10px; margin-bottom: 10px; font-size: 25px; padding: 0 20px 0 20px">SEKOLAH INOVASI-PRODUK UNGGULAN SMK SENOPATI</h1><video controls src="videos/produk_unggulan.mp4" style="width: 90%; margin: 0 auto;"></video><p style= "font-family: arial ;font-size: 12px; text-align: justify; padding: 0 25px 0 25px">Sidoarjo - SMK Senopati mengikuti pameran  produk pusat keunggulan di city of tomorrow  Surabaya.  Pameran yang digelar 27-31 Oktober 2022 itu diikuti 204 SMK PK dan dibuka secara langsung oleh Gubernur Jawa Timur Khofifah Indar Parawansa. Selain pameran karya dan inovasi SMK-PK, EXPO DAN EXPOSE SMK-PK juga menyelenggarakan lomba-lomba dan workshop yang diikuti pengunjung dengan sasaran siswa SMP dan Madrasah Tsanawiyah. <br> <br>SMK SENOPATI menjadi salah satu SMK PUSAT KEUNGGULAN di wilayah sidoarjo khususnya untuk konsentrasi keahlian Rekayasa perangkat lunak. adapun beberapa produk yang ditampilkan dalam pameran / expo smk pusat Keunggulan Jatim Sebagai berikut : <br>Smarthome yakni perangkat IOT yang bisa digunakan untuk menghidupkan ataupun mematikan lampu tanpa saklar manual cukup menggunakan perangkat smartphone dalam penggunaannya smarhome diawal memang ditujukan untuk penyandang disabilitas namu seiring berkembngnya teknologi maka kini smarthome yang diproduksi SMK SENOPATI mendukung 8 channel untuk semua aktifitas yang menggunakan saklar manual pada rumah . kemudian  ada  “App Engine Starter” dimana pada perangkat IOT yang satu ini di fokuskan pada starter engine kendaraan bermotor yang dikendalikan melalui smartphone dalam fiturnya  pengguna dapat menghidupkan atau mematikan motor ,menghidupkan klakson dari jarak maksimal 10 meter menggunakan smartphone <br>Selain itu ada juga produk perangkat lunak yakni  ICONS / Invetory control system untuk manajemen barang -barang baik intansi kecil ataupun perusahaan yang bisa diakses melalui hp maupun laptop serta yang terakhir Running Text / Videotron. Untuk promosi atau reklame digital.</p></div>',
      '<img src="img'+lang+'/19.png"></img>',
      '<img src="img'+lang+'/20.png"></img>',
      '<img src="img'+lang+'/21.png"></img>',
      '<img src="img'+lang+'/22.png"></img>',
      '<img src="img'+lang+'/23.png"></img>',
      '<img src="img'+lang+'/24.png" style="position:relative; z-index: 999"></img>',
      // '<img src="img'+lang+'/8.jpg"></img>',
      // '<img src="img'+lang+'/9.jpg"></img>',
      // '<img src="img'+lang+'/12.jpg"></img>',
      // '<img src="img'+lang+'/13.jpg"></img>',
      // '<img src="img'+lang+'/18.jpg"></img>',
      // '<img src="img'+lang+'/19.jpg"></img>',
      // '<img src="img'+lang+'/20.jpg"></img>',
      // '<img src="img'+lang+'/21.jpg"></img>',
    ];
    
    imgr = $(content[pageNumber - 1]);
    $el.append(imgr);    
    
    return $el;
    // for image
    // imgSrc = 'img/'+pageNumber+'.jpg',
    // $img = $('<img />', {width: '100%', height: '100%', css: {display: 'none'}});
    
    // for video
    // imgSrc = 'videos/'+pageNumber+'.mp4'
    // $img = $.getScript('content.js', function(){
      //   lorem
      // })
    ...
    // $img = $('<video controls width="100%" id="video/'+pageNumber+'"><source src='+imgSrc+' type="video/mp4"></video>', {width: '100%', height: '100%', css: {display: 'none'}});
    
    // Do we need a spinner?
    // let timerAddLoader = setTimeout(function() {
    //   let $loader = $('<div />', {'class': 'ui-spinner'});
    //   $el.append($loader);
    //   timerAddLoader = null;
    // }, 150);
    
    // imgr.on('load', function(event) {
    //   imgr.show();
    ...
    // console.log(imgr);
    // imgr.attr('src', imgSrc);

  },

  _loadRegions: function(pageNumber) {
    let pageData = $('#flipbook').turn('pageData', pageNumber);
    if (!pageData.regions) {
...
let RegionModel = Backbone.Model.extend({
  idAttribute: 'id',
  className: 'none'
});

let RegionView = Backbone.View.extend({
  tagName: 'div',
  className: 'ui-region',
  ...
  render: function() {
    ...
    if (attr.points) {
      let $pageElement = $('#flipbook').turn('pageElement', this.model.pageNumber);
...
let Regions = Backbone.Collection.extend({
  model: RegionModel,
...
let PageSliderView = SingleView.extend({
  el: '#page-slider',
  ...
  _changeValueEvent: function(event, newPage) {
    let currentVal = this.$el.slider('value');
...
let TableContentsView = SingleView.extend({
  tagName: 'div',
  events: {
  ...
  _itemRequested: function(event, itemNum) {
    let text, settings = window.FlipbookSettings;
    if (settings.table) {
      text = settings.table[itemNum].text;
      this._itemPage[settings.table[itemNum].page] = itemNum;
    } else {
      let pages = $('#flipbook').turn('view', this._nextItemPage, true);
  ...
  show: function() {
    let flipbookDisplay = $('#flipbook').turn('display');
    ...
    if ( this._itemPage[currentPage]!==undefined ) {
      ...
      let currentView = $('#flipbook').turn('view', null, true);
...
let MiniaturesView = SingleView.extend({
  el: '#miniatures',
  ...
  _refreshPictureEvent: function(event, pageNumber, $pageElement) {
    let settings = window.FlipbookSettings,
      ...
      $pageElement.html('<img src="img'+lang+'/'+pageNumber+'.png">');
  },
...
/* * * * */
let ControlsView = SingleView.extend({
  el: '#controls',
  _fadeTimer: null,
  ...
  initialize: function() {
    let eventNameToFade = (Turn.isTouchDevice) ? 'vmousedown' : 'vmousemove';
...
let OptionsView = SingleView.extend({
  el: '#options',
  ...
  _vmouseoverIconZoom: function(event) {
    let $sliderView = $('#zoom-slider-view'),
  ...
  _tapIcon: function(event) {
    ...
    switch ($icon.attr('id')) {
      ...
      case 'ui-icon-miniature':
        let miniatures = MiniaturesView.getInstance(),
...
let ZoomSliderView = SingleView.extend({
  el: '#zoom-slider-view',
  ...
  _changeValueEvent: function(event, val) {
    let zoom = val/10 * ($('#flipbook').turn('maxZoom')-1) + 1;
  ...
  show: function() {
    let $sliderEl = this.$el.find('#zoom-slider');
  ...
  hide: function(confirmation) {
    ...
    if ( confirmation ) {
      if (!this._hideTimer) {
        this._hideTimer = setTimeout(function() {
          let $sliderEl = that.$el.find('#zoom-slider');
...
let ShareBox = SingleView.extend({
  ...
  initialize: function() {
    ...
    html +='<div class="ui-share-options">';
      html +='<a title="Facebook" class="ui-icon facebook"></a>';
      html +='<a title="Google+" class="ui-icon google"></a>';
      html +='<a title="Email" class="ui-icon email" href=""></a>';
    html +='</div>';
  ...
  _tapIconEvent: function(event) {
    ...
    switch (title) {
      case 'Facebook':
        window.open('https://web.facebook.com/smksenopatisedati');
      break;
      case 'Twitter':
        window.open('https://twitter.com/share?text='+text+' '+currentUrl, '', winOptions);
      break;
      case 'Google+':
        window.open('https://smksenopati.sch.id');
      break;
      case 'Email':
        window.open('https://mail.google.com/mail/u/0/#inbox?compose=CllgCJvnrrZkzwWvdqTMqLKCWLZsFRHtDclxrWQqZhfNRjkQbRnPnxhHWTqKxhZJNVVqFXskFWL');
      break;
    }
